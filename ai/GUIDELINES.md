...
- Dispatching workers is standing-approved: treat it as already requested and never wait for a per-task go-ahead. Approval is not itself a reason to dispatch — the sizing rule below still decides whether to.
