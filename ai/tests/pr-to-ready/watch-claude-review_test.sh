#!/usr/bin/env bash
# Table test for ai/skills/pr-to-ready/scripts/watch-claude-review.sh: the
...
#   tmp="$(mktemp -d)"
#   git show 2bd1745^:ai/skills/pr-to-ready/scripts/watch-claude-review.sh >"$tmp/old.sh"
#   SUT="$tmp/old.sh" ai/tests/run.sh ai/tests/pr-to-ready/watch-claude-review_test.sh
...
#   git show e14114a^:ai/skills/pr-to-ready/scripts/watch-claude-review.sh >"$tmp/old.sh"
...
SUT="${SUT:-${REPO_ROOT}/ai/skills/pr-to-ready/scripts/watch-claude-review.sh}"
