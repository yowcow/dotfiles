#!/usr/bin/env bash
# Table test for ai/skills/implement-work/scripts/commit-merge.sh: what it
...
#
# RED verification (see ai/tests/README.md). The script is new, so the variants
...
SUT="${SUT:-${REPO_ROOT}/ai/skills/implement-work/scripts/commit-merge.sh}"
